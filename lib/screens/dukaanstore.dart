...
class DukaanStoreScreen extends StatelessWidget {
  static const detailpage1 = "/productdetail";
  newScreen(BuildContext context, String productid) {
    Navigator.of(context).pushNamed(detailpage1, arguments: {"id": productid});
  }
